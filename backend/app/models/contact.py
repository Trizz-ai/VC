"""
Contact model for user information
"""
...
class Contact(Base):
    """Contact model for user information and CRM integration"""
    ...
    # Relationships
    sessions = relationship("Session", back_populates="contact", cascade="all, delete-orphan")
    meetings = relationship("Meeting", back_populates="contacts", secondary="meeting_contacts", lazy="dynamic")
